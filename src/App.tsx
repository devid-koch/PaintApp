      ...
      <div className="h-screen bg-[#F5F5F5] flex items-center ">
        <div className="toolbar w-[20%] py-4 px-5 h-full  bg-white">
          ...
          <div className="mt-5">
            ...
            <button className="px-4 py-3 mt-2 rounded-lg bg-blue-700 text-white border-[#764abc] border-2 border-solid" onClick={handleSave}>Save as Image</button>
          </div>
        </div>
        ...
        <div className="w-[30%] h-full bg-white">
          <h1 className="text-xl font-semibold pt-5 text-center">Drag and Resize these div anywhere on the screen</h1>
          <Rnd className="bg-red-500 text-white font-bold text-center p-4 rounded-md"
            default={{
              x: 150,
              y: 155,
              width: 100,
          ...
          <Rnd className="bg-pink-500 text-white font-bold text-center p-4 rounded-md"
            default={{
              x: 150,
              y: 305,
              width: 100,
          ...
          <Rnd className="bg-green-500 text-white font-bold text-center p-4 rounded-md"
            default={{
              x: 150,
              y: 455,
              width: 100,
